...
<?php
// send_email.php
session_start(); // Bắt buộc có dòng này ở dòng số 2

require_once __DIR__ . '/vendor/autoload.php';
header('Content-Type: application/json; charset=utf-8');

// --- 1. CHỐNG SPAM: GIỚI HẠN TỐC ĐỘ GỬI ---
// Nếu người dùng vừa gửi trong vòng 60 giây trước, chặn lại.
if (isset($_SESSION['last_submit_time'])) {
    $seconds_since_last = time() - $_SESSION['last_submit_time'];
    if ($seconds_since_last < 60) { // 60 giây
        echo json_encode(['success'=>false, 'message'=>'Bạn gửi quá nhanh! Vui lòng chờ 1 phút.']);
        exit;
    }
}
